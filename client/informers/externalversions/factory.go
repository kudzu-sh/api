...
import (
	...
	kudzu "kudzu.sh/api/client/informers/externalversions/kudzu"
)
...
type SharedInformerFactory interface {
	...
	Kudzu() kudzu.Interface
}

func (f *sharedInformerFactory) Kudzu() kudzu.Interface {
	return kudzu.New(f, f.namespace, f.tweakListOptions)
}
